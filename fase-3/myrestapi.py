...
def load_examples():
    try:
        data = pd.read_csv('30_predict.csv')
        examples = []
        ...
        for _ in range(5):
            ...
            boolean_columns = ['Air India', 'GoAir', 'IndiGo', 'Jet Airways', 'Jet Airways Business', 
                               'Multiple carriers', 'Multiple carriers Premium economy', 
                               'SpiceJet', 'Vistara', 'Vistara Premium economy', 'Kolkata', 'Mumbai', 
                               'Hyderabad', 'New Delhi']
...
def _train():
    ...
    try:
        # Crear un Dataframe sin la columna Price y una variable con la columna Price
...
def predict():
    try:
        ...
        # Convertir los valores booleanos a True/False
